...
-- Dumping database structure for sliit_timetable
CREATE DATABASE IF NOT EXISTS `sliit_timetable` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `sliit_timetable`;

-- Dumping structure for table sliit_timetable.building_block
...
INSERT INTO `working_day_management_has_days` (`id`, `working_day_management_wdm_id`, `days_day_id`) VALUES
	...
	(104, 34, 4),
	(105, 34, 5);
/*!40000 ALTER TABLE `working_day_management_has_days` ENABLE KEYS */;
